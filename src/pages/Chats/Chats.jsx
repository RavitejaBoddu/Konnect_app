import { IonCard, IonContent, IonHeader, IonIcon, IonImg, IonItem, IonLabel, IonPage, IonSearchbar, IonTitle, IonToolbar } from '@ionic/react';
import './Chats.css';
    ...
    <IonPage>
      <IonContent fullscreen className='chats-page'>
        <IonCard className='chats-header' lines='none'>
          <IonLabel className='chats-heading'>Chats</IonLabel>
          <IonImg src="assets/images/profile.png" className='profile-pic'/>
          <IonIcon icon={ellipsisVertical} className='chats-vertical-dots' size="large" />
        </IonCard>
